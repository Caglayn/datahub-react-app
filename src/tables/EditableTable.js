    ...
    return (
        <div className="card">
            ...
            <div className="card-body">
                ...
                ></span>
                <table className="table table-bordered table-responsive-md table-striped table-sm text-center">
                    <thead>
                    <tr>
                        <th className="text-center">Person Name <i class="fas fa-sort ml-1"></i></th>
                    ...
                    <tr>
                        ...
                        <td className="pt-3-half" contenteditable="true">Spain</td>
                        <td className="pt-3-half" contenteditable="true">Madrid</td>
                        <td className="pt-3-half">
                        <span className="table-up"
                            ><a href="#!" className="indigo-text"
                            ><i className="fas fa-long-arrow-alt-up" aria-hidden="true"></i></a
                        ></span>
                        <span className="table-down"
                            ><a href="#!" className="indigo-text"
                            ><i className="fas fa-long-arrow-alt-down" aria-hidden="true"></i></a
                        ></span>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td className="pt-3-half" contenteditable="true">Germany</td>
                        <td className="pt-3-half" contenteditable="true">Frankfurt am Main</td>
                        <td className="pt-3-half">
                        <span className="table-up"
                            ><a href="#!" className="indigo-text"
                            ><i className="fas fa-long-arrow-alt-up" aria-hidden="true"></i></a
                    ...
                    <tr className="hide">
                        ...
                        <td className="pt-3-half" contenteditable="true">United Kingdom</td>
                        <td className="pt-3-half" contenteditable="true">London</td>
                        <td className="pt-3-half">
                        <span className="table-up"
                            ><a href="#!" className="indigo-text"
                            ><i className="fas fa-long-arrow-alt-up" aria-hidden="true"></i></a
